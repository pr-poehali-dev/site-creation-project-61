...
Купание в горячих источниках под открытым небом с видом на заснеженные вулканы — must-have любой поездки на Камчатку!`,
  ...
  {
    icon: 'Gem',
    title: 'Вулкан Горелый и лавовые пещеры',
    description: 'Экспедиция к активному вулкану с бирюзовым кислотным озером и уникальными лавовыми пещерами',
    features: ['Кратер с кислотным озером', 'Лавовые пещеры', 'Фумарольные поля'],
    detailedDescription: `Вулкан Горелый — один из самых активных и красивых вулканов Камчатки с 11 кратерами. Главная достопримечательность — огромное бирюзовое кислотное озеро диаметром 800 метров и потрясающие лавовые пещеры.

Программа тура:
• Выезд на внедорожнике к подножию вулкана (2 часа)
• Восхождение к главному кратеру (3-4 часа)
• Прогулка по краю кратера с видом на кислотное озеро
• Спуск в лавовые пещеры с уникальными формациями
• Фумарольные поля с паром и серными отложениями
• Возвращение в базовый лагерь

Маршрут требует хорошей физической подготовки. Незабываемые виды на соседний вулкан Мутновский и океан!`,
    image: 'https://cdn.poehali.dev/projects/4907d0d1-6aad-4fca-a3c7-26424ad91843/files/c5c2fdaa-f809-48f6-8051-4c06001497ee.jpg',
    difficulty: 'сложный'
  },
  {
    icon: 'Mountain',
...
Требуется хорошая физическая подготовка. С вершины открывается потрясающий вид на Корякский, Козельский вулканы и город.`,
  ...
  {
    icon: 'Flame',
    title: 'Малая Долина гейзеров и Мутновская ГеоЭС',
    description: 'Джип-тур к гейзерам, дачным термальным источникам и уникальной геотермальной электростанции',
    features: ['Малая Долина гейзеров', 'Дачные источники', 'Мутновская ГеоЭС'],
    detailedDescription: `Уникальный однодневный маршрут, сочетающий природные чудеса и промышленную достопримечательность. Малая Долина гейзеров — доступная альтернатива знаменитой Долине гейзеров, куда можно добраться на джипе.

Программа тура:
• Выезд на внедорожнике к Мутновскому вулкану (2,5 часа)
• Посещение Малой Долины гейзеров с бьющими гейзерами и грязевыми котлами
• Дачные термальные источники — купание в природных горячих ваннах
• Экскурсия на Мутновскую геотермальную станцию — крупнейшую ГеоЭС России
• Обед на природе

Маршрут средней сложности, подходит для туристов с базовой подготовкой. Захватывающее сочетание дикой природы и высоких технологий!`,
    image: 'https://cdn.poehali.dev/projects/4907d0d1-6aad-4fca-a3c7-26424ad91843/files/3e7ab66c-e2e2-4fe8-9b78-22cc26f4a6c7.jpg',
    difficulty: 'средний'
  },
  {
    icon: 'Plane',
