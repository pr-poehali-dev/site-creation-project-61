...
Купание в горячих источниках под открытым небом с видом на заснеженные вулканы — must-have любой поездки на Камчатку!`,
  ...
  {
    icon: 'Gem',
    title: 'Вулкан Горелый и ледяные пещеры',
    description: 'Экспедиция к активному вулкану с бирюзовым кислотным озером и уникальными ледяными пещерами',
    features: ['Кратер с кислотным озером', 'Ледяные пещеры', 'Фумарольные поля'],
    detailedDescription: `Вулкан Горелый — один из самых активных и красивых вулканов Камчатки с 11 кратерами. Главная достопримечательность — огромное бирюзовое кислотное озеро диаметром 800 метров и потрясающие ледяные пещеры.
...
• Спуск в ледяные пещеры с голубыми сводами и сталактитами
